...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //Llamamos al metodo que crea la carpeta (si esta no existe) y el fichero
        crearCarpetaFichero();
        ...
        try {
            ...
            } else {                                        //Si el proceso 1 tarda más de 30 segundos en terminar, se muestra el mensaje de error
                System.out.println("El proceso 1 ha tardado mas de 30 segundos en terminar");
            }
        } catch (IOException e) {                           //Si hay algún error en la ejecución de los procesos, se muestra el mensaje de error
